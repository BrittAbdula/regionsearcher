...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }) {
  ...
  // const canonical = locale === 'en' ? '/terms-of-service' : `/${locale}/terms-of-service`;
      ...
      <main className="container mx-auto max-w-4xl px-4 py-12 md:px-6 md:py-16">
        <div className="space-y-8">
          <div>
            ...
            <p className="mt-2 text-gray-500 dark:text-gray-400">Effective Date: May 14, 2024</p>
          </div>
          <div className="space-y-4">
            ...
            <ul className="list-disc space-y-2 pl-6 text-gray-500 dark:text-gray-400">
              <li>
                <strong>regionsearcher</strong>: The website and platform operated by regionsearcher Inc.
              </li>
              <li>
                <strong>Service</strong>: The regionsearcher platform and all related services provided by regionsearcher Inc.
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <p>
              The Service, including its content, features, and functionality, is owned by regionsearcher Inc. and is protected by
        ...
        <div className="space-y-4">
            ...
            <p>
                ...
                implied. regionsearcher Inc. does not warrant that the Service will be uninterrupted or error-free, or that defects
                will be corrected.
            </p>
            <p>
                regionsearcher Inc. disclaims all warranties, including but not limited to warranties of merchantability, fitness for
          ...
          <div className="space-y-4">
            ...
            <p>
              In no event shall regionsearcher Inc. be liable for any indirect, special, incidental, or consequential damages
            ...
            <p>regionsearcher Inc.&apos;ss total liability to you for any and all claims shall not exceed $100.</p>
          </div>
          <div className="space-y-4">
            <h2 className="text-2xl font-bold">8. Indemnification</h2>
            <p>
              You agree to indemnify and hold regionsearcher Inc., its affiliates, officers, agents, and employees harmless from any
          ...
          <div className="space-y-4">
            ...
            <p>
              Email: support@regionsearcher.com
            </p>
          </div>
        </div>
      </main>
